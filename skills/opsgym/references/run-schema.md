...
```json
{
  ...
  "outputs": {
    "runDir": "/abs/path/.ops-gym/runs/<run-id>",
    "reportPath": "/abs/path/.ops-gym/reports/<run-id>.html",
    "scoresPath": "/abs/path/.ops-gym/runs/<run-id>/scores.json",
    "rolloutsPath": "/abs/path/.ops-gym/runs/<run-id>/rollouts.json",
    "tracePath": "/abs/path/.ops-gym/runs/<run-id>/trace.md"
  },
  "winner": {},
  "scoreboard": [],
  "wins": {}
